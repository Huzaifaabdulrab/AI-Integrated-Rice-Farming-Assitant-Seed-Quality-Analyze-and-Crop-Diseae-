    ...
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-900 font-sans text-slate-600 dark:text-slate-300 transition-colors duration-300">
      ...
      <div className="py-8 px-6">
        <div className="max-w-5xl mx-auto">
            <Link to="/" className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 transition-colors font-medium mb-4 bg-white dark:bg-slate-900 border border-white px-4 py-2 rounded-full text-sm shadow-sm border border-blue-100 dark:border-slate-700">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-12">
        <div className="bg-white dark:bg-slate-900 border border-white rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
