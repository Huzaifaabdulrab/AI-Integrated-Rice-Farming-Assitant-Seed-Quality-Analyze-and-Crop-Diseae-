    ...
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-900 font-sans text-slate-600 dark:text-slate-300 transition-colors duration-300">
      ...
      <div className="py-8 px-6">
        <div className="max-w-5xl mx-auto">
            <Link to="/" className="inline-flex items-center gap-2 text-rose-700 dark:text-rose-400 hover:text-rose-800 dark:hover:text-rose-300 transition-colors font-medium mb-4 bg-white dark:bg-slate-800 px-4 py-2 rounded-full text-sm shadow-sm border border-rose-100 dark:border-slate-700">
