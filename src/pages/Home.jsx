...
const Home = () => {
  return (
    <div className="p-6 md:p-10 w-full min-h-screen bg-[#f8fafc] dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <Link to="/seed-scan" className="group bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-8 rounded-3xl shadow-sm hover:border-green-500 dark:hover:border-green-400 transition-colors duration-300 relative overflow-hidden flex flex-col h-full">
                ...
                {/* Text adjusted to 2 lines */}
                <p className="text-gray-500 dark:text-slate-300 text-sm mb-6 leading-relaxed">
                    Check seed quality and germination <br className="hidden md:block"/> probability instantly with AI tools.
                </p>
            ...
            <Link to="/disease-scan" className="group bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-8 rounded-3xl shadow-sm hover:border-red-500 dark:hover:border-red-400 transition-colors duration-300 relative overflow-hidden flex flex-col h-full">
                ...
                {/* Text adjusted to 2 lines */}
                <p className="text-gray-500 dark:text-slate-300 text-sm mb-6 leading-relaxed">
                    Identify crop diseases early by <br className="hidden md:block"/> uploading leaf photos instantly.
                </p>
            ...
            <Link to="/yield" className="group bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-8 rounded-3xl shadow-sm hover:border-yellow-500 dark:hover:border-yellow-400 transition-colors duration-300 relative overflow-hidden flex flex-col h-full">
                ...
                {/* Text adjusted to 2 lines */}
                <p className="text-gray-500 dark:text-slate-300 text-sm mb-6 leading-relaxed">
                    Estimate harvest quantity based on <br className="hidden md:block"/> soil quality and weather data.
                </p>
            ...
            {/* Card 4: History */}
            <Link to="/history" className="group bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-8 rounded-3xl shadow-sm hover:border-blue-500 dark:hover:border-blue-400 transition-colors duration-300 relative overflow-hidden flex flex-col h-full">
                ...
                {/* Text adjusted to 2 lines */}
                <p className="text-gray-500 dark:text-slate-300 text-sm mb-6 leading-relaxed">
                    View all your past scans, analysis <br className="hidden md:block"/> reports, and yield data records.
                </p>
